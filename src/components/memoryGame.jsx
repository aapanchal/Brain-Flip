...
function MemoryGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <h1 className="text-3xl font-bold mb-6">Brain Flip</h1>
      <div className="mb-4">
      ...
      <div
        ...
        style={{
          ...
          width: `min(100%, ${gridSize * 7.5}rem)`,
        }}
      >
        {cards.map((card) => {
          return (
      ...
      <button
        ...
        className="mt-4 px-4 py-2 bg-green-900 text-white rounded hover:bg-green-600 transition-colors"
      >
